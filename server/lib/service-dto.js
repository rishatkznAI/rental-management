...
function normalizeServiceTicketRecord(item, index = 0) {
  ...
  return {
    ...
    counterpartyId: stringValue(item.counterpartyId || item.counterparty_id),
    counterpartyName: stringValue(item.counterpartyName),
    customerDisplayName: stringValue(item.customerDisplayName),

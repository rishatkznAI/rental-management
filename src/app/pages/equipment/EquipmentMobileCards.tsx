            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <Link to={detailPath} onClick={(event) => event.stopPropagation()} className="app-shell-title block break-words text-base font-extrabold text-foreground hover:text-primary-content">

...
export function closePlan(overrides = {}) {
  ...
  return {
    ...
    rentalLine: {
      ...
      sourceSystem: overrides.rentalLineSourceSystem || 'isolated_test_adapter',
    ...
    effectiveTerms: overrides.effectiveTermsId
      ...
      : {
          ...
          sourceSystem: overrides.effectiveTermsSourceSystem || 'isolated_test_adapter',
...
export function formPlan(context, overrides = {}) {
  ...
  const lines = overrides.lines || [{
    ...
    sourceSystem: overrides.lineSourceSystem || 'isolated_test_adapter',
    sourceRef: lineRef,
    sourceVersion: 1,
  ...
  return {
    ...
    upd: {
      clientId: overrides.clientId || 'client-1',
      contractId: overrides.contractId === undefined ? 'contract-1' : overrides.contractId,
      sourceSystem: overrides.updSourceSystem || 'isolated_test_adapter',
